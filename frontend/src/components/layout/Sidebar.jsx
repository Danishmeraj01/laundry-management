...
import { LayoutDashboard, ShoppingBag, PlusCircle, LogOut, Shirt, IndianRupee } from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '24px 20px', borderBottom: '1px solid #334155', display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      <div style={{ padding: '16px 20px', borderBottom: '1px solid #334155' }}>
        ...
        <div style={{ fontSize: '11px', color: '#60a5fa', textTransform: 'uppercase' }}>{user?.role}</div>
      </div>
